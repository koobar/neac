...
/* シンプル予測器のエラー */
#define NEAC_ERROR_SIMPLE_PREDICTOR_CANNOT_ALLOCATE_MEMORY  0x0040      /* シンプル予測器で必要な領域のメモリアロケーションに失敗した */
...
/* エントロピー符号化のエラー */
#define NEAC_ERROR_ENTROPY_CODING_INVALID_PARAMETER         0x0070      /* エントロピー符号化に用いられたパラメータが不正なパラメータであった */
...
/* WAVの読み込みエラー */
#define NEAC_ERROR_WAVE_FILE_READER_UNSUPPORTED_DATA        0x00a0      /* wave_file_readerでサポートされていないフォーマットコードが検出された */
#define NEAC_ERROR_WAVE_FILE_READER_FAILED_TO_OPEN_FILE     0x00a1      /* wave_file_readerで開こうとしたファイルを開けなかった */
#define NEAC_ERROR_WAVE_FILE_READER_FMT_CHUNK_NOT_FOUND     0x00a2      /* wave_file_readerでWAVファイルを開こうとしたが、fmt チャンクが見つからなかった */
#define NEAC_ERROR_WAVE_FILE_READER_DATA_CHUNK_NOT_FOUND    0x00a3      /* wave_file_readerでWAVファイルを開こうとしたが、dataチャンクが見つからなかった */
#define NEAC_ERROR_WAVE_FILE_READER_UNSUPPORTED_PCM_BITS    0x00a4      /* wave_file_readerでサンプルを読み込もうとしたが、サポートされていない量子化ビット数であった */
#define NEAC_ERROR_WAVE_FILE_READER_CANNOT_ALLOCATE_MEMORY  0x00a5      /* wave_file_readerでメモリアロケーションに失敗した */

/* WAVの書き込みエラー */
#define NEAC_ERROR_WAVE_FILE_WRITER_CANNOT_ALLOCATE_MEMORY  0x00b0      /* wave_file_writerで必要な領域のメモリアロケーションに失敗した */
#define NEAC_ERROR_WAVE_FILE_WRITER_FAILED_TO_OPEN_FILE     0x00b1      /* wave_file_writerで書き込もうとしたファイルを開けなかった */
